...
macro_rules! rt_test {
    ($($t:tt)*) => {
        pub mod current_thread_scheduler {
            $($t)*
        ...
        pub mod threaded_scheduler_4_threads {
            $($t)*
        ...
        #[cfg(feature = "rt-multi-thread")]
        pub mod threaded_scheduler_1_thread {
            $($t)*
...
rt_test! {
    ...
    //#[test]
    pub fn spawn_many_from_block_on() {
        use tokio::sync::mpsc;
    ...
    //#[test]
    pub fn outstanding_tasks_dropped() {
        let rt = rt();
    ...
    //#[test]
    pub fn complete_block_on_under_load() {
        let rt = rt();
    ...
    //#[test]
    pub fn complete_task_under_load() {
        let rt = rt();
    ...
    //#[test]
    pub fn spawn_from_other_thread_idle() {
        let rt = rt();
        let handle = rt.clone();
    ...
    //#[test]
    pub fn spawn_from_other_thread_under_load() {
        let rt = rt();
        let handle = rt.clone();
    ...
    //#[test]
    pub fn spawn_blocking_from_blocking() {
        let rt = rt();
    ...
    // test is disabled.
    #[cfg(not(windows))]
    pub fn io_driver_called_when_under_load() {
        let rt = rt();
    ...
    //#[test]
    pub fn eagerly_drops_futures_on_shutdown() {
        use std::sync::mpsc;
    ...
    //#[test]
    pub fn wake_while_rt_is_dropping() {
        use tokio::task;
    ...
    //#[test]
    pub fn io_notify_while_shutting_down() {
    ...
    //#[test]
    #[cfg(not(windows))]
    pub fn runtime_in_thread_local() {
    ...
    //#[test]
    pub fn local_set_block_on_socket() {
        let rt = rt();
    ...
    //#[test]
    pub fn local_set_client_server_block_on() {
        let rt = rt();
        let (tx, rx) = mpsc::channel();
