...
#[tokio::test]
pub async fn test_basic_transfer() {
...
#[tokio::test]
pub async fn test_transfer_after_close() {
...
#[tokio::test]
pub async fn blocking_one_side_does_not_block_other() {
    symmetric(|handle, mut a, mut b| async move {
...
#[tokio::test]
pub async fn immediate_exit_on_error() {
    symmetric(|handle, mut a, mut b| async move {
        block_write(&mut a).await;
