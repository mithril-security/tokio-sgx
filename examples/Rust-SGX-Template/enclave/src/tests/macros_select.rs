...
#[tokio::test]
pub async fn sync_one_lit_expr_comma() {
...
#[tokio::test]
pub async fn sync_one_lit_expr_no_comma() {
    let foo = tokio::select! {
        foo = async { 1 } => foo
    };
...
#[tokio::test]
pub async fn sync_one_lit_expr_block() {
    let foo = tokio::select! {
        foo = async { 1 } => { foo }
    };
...
#[tokio::test]
pub async fn move_uncompleted_futures() {
...
#[tokio::test]
pub async fn mutable_borrowing_future_with_same_borrow_in_block() {
    let mut value = 234;
...
#[tokio::test]
pub async fn mutable_borrowing_future_with_same_borrow_in_block_and_else() {
    let mut value = 234;
...
#[tokio::test]
pub async fn future_panics_after_poll() {
    use tokio_test::task;
...
#[tokio::test]
pub async fn use_future_in_if_condition() {
...
#[tokio::test]
pub async fn use_future_in_if_condition_biased() {
    use tokio::time::{self, Duration};
...
#[tokio::test]
pub async fn never_branch_no_warnings() {
    let t = tokio::select! {
        _ = async_never() => 0,
...
#[tokio::test]
pub async fn mut_on_left_hand_side() {
    let v = async move {
        let ok = async { 1 };
        tokio::pin!(ok);
        tokio::select! {
...
#[tokio::test]
pub async fn biased_one_not_ready() {
...
#[tokio::test]
pub async fn biased_eventually_ready() {
