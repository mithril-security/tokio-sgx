...
#[tokio::test]
pub async fn test_buffered_reader() {
...
#[tokio::test]
pub async fn test_buffered_reader_seek() {
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
...
#[tokio::test]
pub async fn test_buffered_reader_seek_underflow() {
...
#[tokio::test]
pub async fn maybe_pending_buf_read() {
...
#[tokio::test]
pub async fn maybe_pending_seek() {
...
#[tokio::test]
pub async fn test_fill_buf_wrapper() {
