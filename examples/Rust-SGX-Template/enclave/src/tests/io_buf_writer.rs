...
use super::support::io_vec::IoBufs;
...
#[tokio::test]
pub async fn buf_writer_inner_flushes() {
...
#[tokio::test]
pub async fn maybe_pending_buf_writer() {
...
#[tokio::test]
pub async fn maybe_pending_buf_writer_inner_flushes() {
...
#[tokio::test]
pub async fn maybe_pending_buf_writer_seek() {
...
#[tokio::test]
pub async fn write_vectored_empty_on_non_vectored() {
...
#[tokio::test]
pub async fn write_vectored_empty_on_vectored() {
...
#[tokio::test]
pub async fn write_vectored_basic_on_non_vectored() {
...
#[tokio::test]
pub async fn write_vectored_basic_on_vectored() {
    let msg = b"foo bar baz";
    let bufs = [
        IoSlice::new(&msg[0..4]),
        IoSlice::new(&msg[4..8]),
...
#[tokio::test]
pub async fn write_vectored_large_total_on_non_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&msg[0..4]),
        IoSlice::new(&msg[4..8]),
...
#[tokio::test]
pub async fn write_vectored_large_total_on_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&msg[0..4]),
        IoSlice::new(&msg[4..8]),
...
#[tokio::test]
pub async fn write_vectored_odd_on_non_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&msg[0..4]),
        IoSlice::new(&[]),
...
#[tokio::test]
pub async fn write_vectored_odd_on_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&msg[0..4]),
        IoSlice::new(&[]),
...
#[tokio::test]
pub async fn write_vectored_large_slice_on_non_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&[]),
        IoSlice::new(&msg[..9]),
...
#[tokio::test]
pub async fn write_vectored_large_slice_on_vectored() {
    let msg = b"foo bar baz";
    let mut bufs = [
        IoSlice::new(&[]),
        IoSlice::new(&msg[..9]),
